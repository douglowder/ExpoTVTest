...
import com.expotvtest.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.expotvtest.ReactNativeFlipper");
        aClass
